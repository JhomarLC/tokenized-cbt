...
import { idlFactory } from './dclsu_frontend.did.js';
export { idlFactory } from './dclsu_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DCLSU_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dclsu_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dclsu_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dclsu_frontend.did.js")._SERVICE>}
 */
export const dclsu_frontend = createActor(canisterId);
