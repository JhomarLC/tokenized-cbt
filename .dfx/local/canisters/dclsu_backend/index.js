...
import { idlFactory } from './dclsu_backend.did.js';
export { idlFactory } from './dclsu_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DCLSU_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dclsu_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dclsu_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dclsu_backend.did.js")._SERVICE>}
 */
export const dclsu_backend = createActor(canisterId);
